...
Run after building: python3 quality/tests/app/reliability_review.py
"""
import argparse
...
spec = importlib.util.spec_from_file_location('protocol_harness', ROOT / 'quality/tests/protocol.py')
...
def main():
    ...
    parser.add_argument('--report', type=Path, default=ROOT / 'quality/artifacts/reliability-review-results.json')
