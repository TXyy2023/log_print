...
| 主程序/CLI | 真实Core及插件的直接父子PID、原始字节、配置/令牌、启停重启、正常回收、半途启动失败、Core死亡、启动中SIGINT已有4组通过 |
...
| macOS完整套件 | 统一入口9个阶段全部通过；18项Rust测试，协议11组、生命周期4组、独立可靠性6组、IO5组及UI6组；serial PTY 1项明确跳过 |
